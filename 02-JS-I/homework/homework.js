...
function elevar(num, exponent) {
  ...
  // Tu código:
  var resultado = Math.pow(num,exponent)//num ** exponente
  return resultado;
}
...
function retornarPerimetro(lado){
  ...
  var perimetro = lado + lado + lado +lado; //lado *4
  return perimetro; 
}
...
function esVocal(letra){
  ...
  else if (letra==="a" || letra==="e" || letra==="i" || letra==="o" || letra==="u"){// letra === "a"|| "e" ||"i"
